...
type MoveCommand = {tryMoveToPos:Position;entity:Entity}
type AttackCommand = {attacker:Entity;defender:Entity}

type KeyPressedEvent = {keyPressed:ConsoleKey;entity:Entity}
type MovedEvent = {movedToPos:Position;entity:Entity}
type CollisionEvent = {collider:Entity;collidedWith:Entity}
type DamageTakenEvent = {damageAmount:int;healthComponent:Component<Health>;entity:Entity}
