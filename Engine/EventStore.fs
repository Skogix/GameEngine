...
type skogixEventStore() =
  static let history = []
  static let mailbox = MailboxProcessor.Start(fun inbox ->
  ...
  static member Append(event) = mailbox.Post (Append [event])
  static member GetAll() = mailbox.PostAndReply Get
//let initEventStore() =
//  let history = []
